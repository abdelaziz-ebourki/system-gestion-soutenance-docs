...
\textbf{Visual Studio Code} est l'éditeur utilisé pour l'ensemble du développement, avec des extensions dédiées au TypeScript, Tailwind CSS et React pour le frontend, et au Java, Spring Boot et Maven pour le backend. \textbf{Postman} permet de tester et documenter les endpoints REST, avec des environnements séparés pour le dev et les tests, et des collections partagées entre les membres de l'équipe. \textbf{Maven} gère les dépendances du projet backend, assure la cohérence des versions et intègre les plugins de qualité de code.
