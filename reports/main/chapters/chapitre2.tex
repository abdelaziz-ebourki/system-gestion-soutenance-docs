...
L'application adopte une architecture web moderne en trois couches, favorisant la modularité et la séparation des préoccupations. \Cref{fig:component_architecture} présente la vue composants du système, détaillant les modules de chaque couche.
