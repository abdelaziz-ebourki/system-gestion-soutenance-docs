...
Nous présentons dans ce chapitre une analyse approfondie du système actuel d'organisation des soutenances au sein de la faculté, identifions ses lacunes et comparons les solutions existantes sur le marché. Il détaille ensuite les choix technologiques retenus pour le développement de notre application. Enfin, l'architecture générale du système est présentée ; la stratégie de déploiement et l'organisation du code source sont détaillées aux chapitres suivants (cf. \cref{ch3:architecture_logicielle,ch4:architecture}).
...
L'application adopte une architecture \acrshort{api}-first en trois couches, détaillée dans la conception (\cref{ch3:architecture_logicielle}) et l'implémentation (\cref{ch4:architecture}).
