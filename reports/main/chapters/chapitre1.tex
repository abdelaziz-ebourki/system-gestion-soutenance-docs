...
\begin{table}[H]
    ...
    \begin{tabular}{lp{10cm}}
        ...
        Effectif étudiant (2015--2016) & $\approx$ 11\,500 étudiants \\
        \bottomrule
    \end{tabular}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
            ...
            every node/.style={draw, rounded corners, align=center, fill=primary!5, font=\small},
            edge from parent/.style={draw, -latex}
        ]
        \node {Doyen}
        child {node {Vice-Doyen\\Pédagogique}
                child {node {Conseil de\\département}}
            }
        child {node {Vice-Doyen\\Recherche}
                child {node {Laboratoires}}
            }
        child {node {Secrétaire\\Général}
                child {node {Services\\administratifs}}
            };
    \end{tikzpicture}
    \caption{Organigramme simplifié de la FSBM}
...
La structuration pédagogique repose sur six départements, chacun responsable d'une ou plusieurs filières. Le Département de Mathématiques propose les licences en Mathématiques Fondamentales et Appliquées, en plus des masters spécialisés. Le Département d'Informatique est responsable de la filière Licence MIP (Mathématiques, Informatique et Physique) et de plusieurs masters en informatique, incluant des spécialités telles que Data Sciences et Big Data, Intelligence Artificielle, et Traitement de l'Information. Les autres domaines sont couverts par le Département de Physique, le Département de Chimie, le Département de Biologie et le Département de Géologie, qui offrent chacun des formations spécialisées.
...
Notre projet de fin d'études s'est déroulé au sein de la filière \textbf{Licence Fondamentale MIP (Mathématiques, Informatique et Physique)} du Département d'Informatique. Cette filière, créée pour former des étudiants polyvalents possédant une solide base en mathématiques et une maîtrise des technologies de l'information, a été conçue en réponse à la demande croissante du secteur technologique marocain pour des profils à l'interface entre les mathématiques et l'informatique. La formation couvre des domaines variés tels que le développement logiciel, les bases de données, les réseaux, l'algorithmique avancée et l'intelligence artificielle, tout en maintenant un socle mathématique rigoureux incluant l'analyse, l'algèbre, les probabilités et les statistiques.
...
Le projet de système de gestion des soutenances et des jurys s'inscrit dans une volonté de modernisation des processus administratifs et pédagogiques au sein de la faculté. Actuellement, l'organisation des soutenances -- qu'il s'agisse des soutenances de PFE, de mémoires de master ou de thèses -- repose sur des méthodes manuelles et des outils bureautiques génériques. Les coordinateurs utilisent des fichiers Excel pour suivre les projets, des emails pour communiquer avec les enseignants et les étudiants, et des supports papier pour les convocations et les procès-verbaux. Cette organisation, bien que fonctionnelle pour un petit nombre de soutenances, montre rapidement ses limites lorsque le volume d'étudiants augmente.

Le département MIP, confronté à un volume croissant d'étudiants -- avec plusieurs centaines d'étudiants par promotion -- et à une complexité accrue dans la coordination des jurys, a identifié le besoin d'un outil informatique dédié. Les problèmes les plus fréquemment rencontrés incluent les conflits d'horaires entre enseignants, les erreurs de planification liées à la manipulation manuelle de grandes quantités de données, l'absence de traçabilité des décisions prises lors de l'organisation des sessions, et la lourdeur de la génération des documents administratifs (convocations, fiches d'évaluation, procès-verbaux). Ces difficultés sont amplifiées lors des sessions de rattrapage, où la planification doit être reprise en tenant compte des contraintes de disponibilité des enseignants et des salles déjà partiellement occupées.

Ce projet a donc été proposé par \textbf{Pr. Mohammed AIT DAOUD} dans le cadre des projets de fin d'études de la licence MIP, avec pour objectif de fournir une solution concrète et opérationnelle répondant aux besoins réels du département. Le choix de ce sujet reflète la volonté de la faculté de s'appuyer sur les compétences de ses propres étudiants pour moderniser ses outils de gestion, tout en offrant aux futurs diplômés l'opportunité de travailler sur un projet à dimension réelle.

\subsubsection{Encadrement et organisation du stage}
\label{ch1:encadrement}

Le stage s'est déroulé sous la double supervision de \textbf{Pr. Mohammed AIT DAOUD}, professeur au département d'Informatique de la FSBM, et de \textbf{Dr. Salma SAMMAH}, également membre du corps enseignant de la filière MIP. Cette structure d'encadrement a permis de bénéficier de orientations complémentaires : une vision architecturale et méthodologique du côté de Pr. AIT DAOUD, et un regard plus orienté vers les aspects fonctionnels et la validation métier du côté de Dr. SAMMAH.

Les deux étudiants responsables du projet se sont réparti les tâches en fonction de leurs centres d'intérêt et de leurs compétences complémentaires. L'un s'est principalement concentré sur le développement du backend (API REST, logique métier, sécurité) et l'autre sur le frontend (interface utilisateur, composants React, intégration des designs). Cette répartition a permis un développement parallèle efficace, chaque étudiant travaillant de manière autonome tout en maintenant une coordination étroite via des points réguliers et un dépôt Git commun.

Le suivi du projet s'est organizé autour de réunions hebdomadaires avec les encadrants, au cours desquelles l'avancement était présenté, les difficultés étaient discutées et les orientations techniques étaient validées. Cette organisation agile a permis d'ajuster le périmètre du projet en cours de développement, en priorisant les fonctionnalités critiques (planification, détection de conflits) par rapport aux fonctionnalités secondaires qui pouvaient être reportées.

\subsection{Conclusion}
\label{ch1:conclusion}

La Faculté des Sciences Ben M'Sick constitue un cadre académique riche et diversifié, comptant plusieurs milliers d'étudiants et offrant des formations scientifiques de qualité dans un large éventail de disciplines. Le département MIP, par sa proximité avec les technologies de l'information et par le volume croissant de ses étudiants, est confronté à des défis croissants dans l'organisation de ses soutenances. Ce constat, combiné à la volonté de modernisation de la faculté -- qui a déjà engagé sa transformation numérique à travers le système LMD et la plateforme PINTECH -- et à l'expertise technique disponible au sein de son corps étudiant, a créé le contexte idéal pour le développement d'une solution numérique de gestion des soutenances. Ce contexte a directement inspiré les choix technologiques et architecturaux qui seront présentés dans les chapitres suivants.
